...
export class EmployeehttpComponent implements OnInit
 {
    ...
    getData1_click()
    {
      this.dataService.getEmployeeByJob("IT").subscribe(resData =>
        {
          this.result = resData;
          this.clearFields();
        });
    ...
    getData2_click()
    {
      this.dataService.getManagerNameInDepartment(10).subscribe(resData =>
        {
          this.result = resData;
          this.clearFields();
        });
    ...
    getData3_click()
    {
      this.dataService.getEmployeeNotInDepartment().subscribe(resData =>
        {
          this.result = resData;
          this.clearFields();
        });
    ...
    getData4_click()
    {
      this.dataService.getEmployeeNameandDesignation().subscribe(resData =>
        {
          this.result = resData;
        })
    }
    ...
    getData5_click()
    {
      this.dataService.getSalaryonSorting().subscribe(resData =>
        {
          this.result = resData;
        })
    }
